...
declare -A OS_OPTIONS=(
    ...
    ["Ubuntu 24.10"]="ubuntu|questing|https://cloud-images.ubuntu.com/releases/server/25.10/release/ubuntu-25.10-server-cloudimg-amd64.img|ubuntu25|ubuntu|ubuntu"
